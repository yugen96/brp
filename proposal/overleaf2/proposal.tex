...
\coverpicture{\includegraphics[width=0.9\textwidth]{NGC4696pol.jpeg}}



\abstract{
    Recent studies have revealed that gas filaments surrounding cool-core galaxies often behave unexpectedly: although these structures should fall into the galaxy centers at velocities above $600 \unit{km \hspace{1mm} s^{-1}}$, they seem to remain relatively stable over galactic timescales, displaying infall velocities barely exceeding $100 \unit{km \hspace{1mm} s^{-1}}$\citep{Jaffe2005, Fabian2008, Fabian2016}. This discrepancy is purportedly caused by the presence of magnetic fields, although the existence of these fields has yet to be confirmed by direct observational evidence. Within this proposal, we suggest to analyze the presumed magnetic fields within the filaments of NGC4696 by means of polarimetric imaging techniques. The final goal is to create a map describing the polarization degrees within the gas filaments and to analyze the influence of magnetic fields on their stability.
}
