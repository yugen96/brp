...
for i, std_dir in enumerate(std_dirs): 
    ...
    for j, tpl_name in enumerate(tpl_dirlst[skip_lst[i]::]): 
        ...
        if filter_lst[j] == "b_HIGH":
            ...
            plt.errorbar(U_jqr[j,-4::,std_rad-1], Q_jqr[j,-4::,std_rad-1], xerr = sigmaU_jqr[j,-4::,std_rad-1], yerr = sigmaQ_jqr[j,-4::,std_rad-1], fmt='s', markersize = 10., color = Bcolor_lst[b])
        ...
        if filter_lst[j] == "v_HIGH":
            ...
            plt.errorbar(U_jqr[j,-4::,std_rad-1], Q_jqr[j,-4::,std_rad-1], xerr = sigmaU_jqr[j,-4::,std_rad-1], yerr = sigmaQ_jqr[j,-4::,std_rad-1], fmt='s', markersize = 10., color = Vcolor_lst[v])
