...
for starno, starpar in enumerate(star_lsts[0]):
    ...
    # Save original O-E
    savefits(embedO-embedE, imdir+"/backgrtest5_star{}".format(starno+1), "slitdiff_star{}".format(starno+1)) 
    savefits(cutoutO, imdir+"/backgrtest5_star{}".format(starno+1), "O_star{}".format(starno+1))       
    savefits(cutoutE, imdir+"/backgrtest5_star{}".format(starno+1), "E_star{}".format(starno+1)) 
    # Save embeded O and E
    savefits(embedO, imdir+"/backgrtest5_star{}".format(starno+1), "embedO_star{}".format(starno+1)) 
    savefits(embedE, imdir+"/backgrtest5_star{}".format(starno+1), "embedE_star{}".format(starno+1)) 
    ...
    for extradx, extrady in carthprod(range(-1,2),range(-1,2)):
        testEembed = embed(cutoutE, framesize, 
                           ...
                           cornerpix=lowlcorn)
        savefits(embedO-testEembed, imdir+"/backgrtest5_star{}/pixofftests".format(starno+1), 
    ...
    bckgO_an, bckgO_an_err = ansum(embedO, embedOcent[0], embedOcent[1], 1.2*starpar[3], 4*starpar[3])
    bckgE_an, bckgE_an_err = ansum(embedE, embedOcent[0], embedOcent[1], 1.2*starpar[3], 4*starpar[3])
    ...
    savefits(Ocorr_reg, imdir+"/backgrtest5_star{}".format(starno+1), "Ocorr_reg_star{}".format(starno+1))
    savefits(Ecorr_reg, imdir+"/backgrtest5_star{}".format(starno+1), "Ecorr_reg_star{}".format(starno+1))
    savefits(Ocorr_an, imdir+"/backgrtest5_star{}".format(starno+1), "Ocorr_an_star{}".format(starno+1))
    savefits(Ecorr_an, imdir+"/backgrtest5_star{}".format(starno+1), "Ecorr_an_star{}".format(starno+1))
    ...
    bckgO_corran_an, bckgO_corran_an_err = ansum(Ocorr_an, embedOcent[0], embedOcent[1], 1.2*starpar[3], 4*starpar[3])
    bckgE_corran_an, bckgE_corran_an_err = ansum(Ecorr_an, embedOcent[0], embedOcent[1], 1.2*starpar[3], 4*starpar[3])
    ...
    savefits(slitdiff_regcorr, imdir+"/backgrtest5_star{}".format(starno+1), "slitdiff_regcorr_star{}".format(starno+1))
    savefits(slitdiff_ancorr, imdir+"/backgrtest5_star{}".format(starno+1), "slitdiff_anncorr_star{}".format(starno+1))    
    ...
    os.chdir(savedir)                
    savefile1 = open("tables5_star{}".format(starno+1),'w')
